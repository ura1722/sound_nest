  ...
  const [albumDialogOpen, setAlbumDialogOpen] = useState(false);
	...
	const handleSubmit = async () => {
		...
		try {
			...
			formData.append("albumTitle", newAlbum.albumTitle);
			formData.append("albumAuthor", newAlbum.albumAuthor);
			...
			<DialogContent className='bg-zinc-900 border-zinc-700'>
				...
				<div className='space-y-4 py-4'>
					...
					<div className='space-y-2'>
						...
						<Input
							...
							onChange={(e) => setNewAlbum({ ...newAlbum, albumRelease: parseInt(e.target.value) })}
							className='bg-zinc-800 border-zinc-700'
				...
				<DialogFooter>
					...
					<Button
						...
						disabled={isLoading || !imageFile || !newAlbum.albumTitle || !newAlbum.albumAuthor}
					>
